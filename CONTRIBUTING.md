...
We're working hard to make *bitcore* the most powerful JavaScript library for working with auroracoin. Our goal is to have *auroracoin* be a library that can be used by anyone interested in auroracoin, and to level expertise differences with great design and documentation.
