...
describe('Transaction', function() {
  ...
  var testTransaction = new Transaction()
    ...
    .to('aurt1qy265w5ntr6u08rnms5lr66khn39xzyv5wx8ata', testAmount - 10000);
  ...
  it('will not accept NaN as an amount', function() {
    (function() {
      var stringTx = new Transaction().to('aurt1qy265w5ntr6u08rnms5lr66khn39xzyv5wx8ata', NaN);
  ...
  var fromAddress = 'aurt1qy265w5ntr6u08rnms5lr66khn39xzyv5wx8ata';
  var simpleUtxoWith100000Satoshis = {
    address: fromAddress,
    txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
    outputIndex: 0,
    script: Script.buildWitnessV0Out(fromAddress).toString(),
    satoshis: 100000
  };
  ...
  var toAddress = 'aurt1qy265w5ntr6u08rnms5lr66khn39xzyv5wx8ata';
  var changeAddress = 'aurt1q9xj5ray8dan5cfq5gk6ejq5pywrsf7fm3dwyxu';
  var changeAddressP2WSH = 'aurt1qxw95r7g7h2ahf56rpmnmpfpw76lm3a6w3k9jnww8x82fs0epsfhqjmpnya';
  ...
  var p2shPrivateKey1 = PrivateKey.fromWIF('KwdyTMGAPFu4XJcUuRSVdikYPDJkrpw7btZ6X7NBdpqa6WHKGPqn');
  var p2shPublicKey1 = p2shPrivateKey1.toPublicKey();
  var p2shPrivateKey2 = PrivateKey.fromWIF('KwqpVmuvLFTLVNE8PTXrqzQM1XhwdZLDkKMqkB7zt9cabjc9GSL9');
  var p2shPublicKey2 = p2shPrivateKey2.toPublicKey();
  var p2shPrivateKey3 = PrivateKey.fromWIF('L1UzDAvyVDwjeWE2QDU62Ch8Va4gYwBJNAHLbjxkAZWU32gGaT7c');
  ...
  describe('change address', function() {
    ...
    it('fee per kb can be set up manually', function() {
      ...
      var transaction = new Transaction()
        ...
        .change(changeAddress)
        .sign(privateKey);
      transaction._estimateSize().should.be.within(400, 1999);
      transaction.outputs.length.should.equal(2);
      transaction.outputs[1].satoshis.should.equal(42000);
    });
  ...
  describe('serialization of inputs', function() {
    it('can serialize and deserialize a P2WPKH input', function() {
      var transaction = new Transaction()
        .from(simpleUtxoWith1BTC);
      var deserialized = new Transaction(transaction.toObject());
      expect(deserialized.inputs[0] instanceof Transaction.Input.WitnessPublicKeyHash).to.equal(true);
    });
