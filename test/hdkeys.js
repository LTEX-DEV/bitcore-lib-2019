...
var HDPrivateKey = auroracoin.HDPrivateKey;
var HDPublicKey = auroracoin.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = auroracoin.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(auroracoin.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(auroracoin.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      auroracoin.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = auroracoin.PublicKey.fromPoint;
      auroracoin.PublicKey.fromPoint = function() {
        auroracoin.PublicKey.fromPoint = unstubbed;
