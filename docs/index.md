...
* [Acknowledging and Requesting Payments: Auroracoin URIs](uri.md)
* [The Transaction Class](transaction.md)

## Auroracoin Internals
* [Scripts](script.md)
* [Block](block.md)
...
* [Auroracoin Core JSON-RPC](https://github.com/bitpay/bitcoind-rpc)
...
var imported = auroracoin.PrivateKey.fromWIF(exported);
...
var p2shAddress = new auroracoin.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new auroracoin.URI(paymentInfo).toString();
```
