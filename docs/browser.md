# Browser Builds
Auroracoin.JS and most official submodules work in the browser, thanks to [browserify](http://browserify.org/) (some modules are not fully compatible with web browsers).
...
<head>
  <meta charset="utf-8">
  <script src="bower_components/auroracoin/auroracoin.min.js"></script>
...
```sh
browserify --require ./index.js:auroracoin | uglifyjs > auroracoin.min.js
```

```sh
browserify --require ./index.js:auroracoinjs-mnemonic --external auroracoin | uglifyjs > auroracoinjs-mnemonic.min.js
```
