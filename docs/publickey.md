# Public Key
Represents a auroracoin public key and is needed to be able to receive auroracoin, as is usually represented as a auroracoin [Address](address.md). See the official [Bitcoin Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).

A PublicKey in Auroracoin.JS is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = auroracoin.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new auroracoin.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = auroracoin.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
